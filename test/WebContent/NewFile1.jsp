...
<body>
    ...
    <div align="center">	
        ...
        url="jdbc:mysql://localhost:3306/bioinformatics?useSSL=false"
        user="root" 																															                                              password=""
    />
	...
	<sql:query var="listUsers" dataSource="${ListOfUsers}">
        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="genes" items="${listUsers.rows}">
                <tr>
                    <td><c:out value="${genes.TUBB1}" /></td>
                    <td><c:out value="${genes.ACR_Class}" /></td>
                    <td><c:out value="${genes.ANXA5}" /></td>
                    <td><c:out value="${genes.AP1M1}" /></td>
